...
<body class="">
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div class="link-container z-8 bg-body">
                    <ul class="mb-0 list-unstyled d-md-initial d-lg-flex">
                        <li><a class="btn btn-white my-md-2 shadow-0 mx-lg-1 @yield('home')" href="">Home</a>
                        </li>

                        @livewire('child.shop-menu')

                        <li><a class="btn btn-white my-md-2 shadow-0 mx-lg-1 @yield('about-us')" href="">About
                                Us</a></li>
                        <li><a class="btn btn-white my-md-2 shadow-0 mx-lg-1 @yield('contact-us')" href=" ">Contact Us</a></li>
                    </ul>
                </div>
                <div class="">
                    ...
                    @guest
                    <a href="" class="btn btn-white btn-floating" data-mdb-toggle="tooltip" title="Login/Register"><i class="fas fa-sign-in-alt"></i></a>
                    @endguest
                    @auth
                    ...
                    <ul class="dropdown-menu dropdown-menu-end rounded-3 bg-white">
                        ...
                        <div class="py-2">
                            <li><a href="" class="dropdown-item f-500">
                                    <i class="fas fa-user-alt mr-3"></i>Profile</a></li>
                            <li>
                                <a href="" class="dropdown-item f-500">
                            ...
                            <li><a href="" class="dropdown-item f-500" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <div class="p-4 text-center bg-black w-100">
        <h4 class="small-font text-light p-4 f-300">Copyright&copy; <a href="" class="text__primary">e-com</a> {{ date('Y') }}. All
            Right
            Reserved.</h4>
    </div>
    <!--Footer-->
